          ...
          <Grid container spacing={4} sx={{ alignItems: 'center', justifyContent: 'space-between' }}>
            ...
            <Grid item xs={12}>
              <Box>
                ...
                <Box sx={{ marginTop: 1 }}>
                  <CkEditorForEdit isEdit={true} textEditor={contentAr} setTextEditorVal={setContentAr} />
                </Box>
              </Box>
            </Grid>
            ...
            <Grid item xs={12}>
              <Box>
                ...
                <Box sx={{ marginTop: 1 }}>
                  <CkEditorForEdit isEdit={true} textEditor={contentEn} setTextEditorVal={setContentEn} />
                </Box>
              </Box>
            </Grid>
