...
import LoginMethodsTableHeader from './LoginMethodsTableHeader'
...
const LoginMethodsList = ({
  ...
  return (
    <div>
      <Card>
        <CardHeader title={t('login_methods')} />
        <CustomDataGrid
          toolbar={LoginMethodsTableHeader}
          toolbarProps={{
            value: search,
