...
const LoginMethodsDetails = ({ data }) => {
  const { t } = useTranslation()
  const { id, active, name_en, name_ar, image, description_ar, description_en, slug } = data
  ...
  const handleEdit = e => {
    e.stopPropagation()
    router.push(`/login_methods/edit/${id}`)
  }
              ...
              <Box sx={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
                ...
                <Box sx={{ display: 'flex', gap: 3 }}>
                  ...
                  <Box sx={{ display: 'flex' }}>
                    ...
                    <Typography sx={{ color: 'text.secondary' }}>{description_en}</Typography>
                  </Box>
                </Box>
                ...
                <Box sx={{ display: 'flex', gap: 3 }}>
                  ...
                  <Box sx={{ display: 'flex' }}>
                    ...
                    <Typography sx={{ color: 'text.secondary' }}>{description_ar}</Typography>
                  </Box>
                </Box>
...
export default LoginMethodsDetails
