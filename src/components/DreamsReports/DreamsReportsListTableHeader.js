...
import { deleteDreamsReports, exportDreamsReports } from './dreamsReportsServices'

const DreamsReportsListTableHeader = ({ selectedRows, onChange, value, clearSearch, fetchData, canExport }) => {
  ...
  const handleDelete = () => {
    deleteDreamsReports(selectedRows).then(res => {
      setOpenDeleteSnackbar(false)
      fetchData()
    })
  }
...
export default DreamsReportsListTableHeader
