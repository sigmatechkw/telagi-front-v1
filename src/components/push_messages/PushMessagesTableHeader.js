...
const PushMessagesTableHeader = props => {
  ...
  const handleDelete = () => {
    deletePushMessage(props.selectedRows).then(res => {
  ...
  return (
    ...
    >
      <Box sx={{ rowGap: 2, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        <Button onClick={() => router.push('/push_messages/create')} variant='contained' sx={{ '& svg': { mr: 2 } }}>
...
export default PushMessagesTableHeader
