...
const AttributesSetsTableHeader = ({ selectedRows, onChange, value, clearSearch, fetchData, canExport }) => {
  ...
  const handleDelete = () => {
    deleteAttributesSets(selectedRows).then(res => {
      setOpenDeleteSnackbar(false)
      fetchData()
    })
  }
...
export default AttributesSetsTableHeader
